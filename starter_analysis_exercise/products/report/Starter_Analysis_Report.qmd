...
#| echo: FALSE
knitr::include_graphics(here("starter_analysis_exercise","results","figures","height_weight_stratified.png"))
```
...
#| echo: FALSE
resulttable2 = readRDS(here("starter_analysis_exercise","results","tables-files","resulttable2.rds"))
