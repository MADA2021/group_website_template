...
data_location <- here::here("starter_analysis-exercise","data","raw_data","exampledata.xlsx")
...
```{r}
save_data_location <- here::here("starter_analysis-exercise","data","processed_data","processeddata.rds")
